...
python copyNano.py --xrdcp -f 'JSON' -f "$1" -o 'nano.root' -s 'nFatJet >0 || MET_pt > 200' && { mv -v FrameworkJobReport_ok.xml  FrameworkJobReport.xml ; }
#python copyNano.py --xrdcp -f 'JSON' -f "$1" -o 'nano.root' && { mv -v FrameworkJobReport_ok.xml  FrameworkJobReport.xml ; }
